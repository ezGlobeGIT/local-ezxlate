...
/**
 * Class to manage a unilabel activity plugin
 * 
...
class unilabel extends \local_ezxlate\entity {
    ...
    protected function define_fields() {
        ...
        if ($this->record("unilabeltype") == "accordion") {
            ...
            if (!empty($record)) {
                $values = database::get_all("unilabeltype_accordion_seg", $record->id, "accordionid");
        ...
        if ($this->record("unilabeltype") == "carousel") {
            ...
            if (!empty($record)) {
                $values = database::get_all("unilabeltype_carousel_slide", $record->id, "carouselid");
        ...
        if ($this->record("unilabeltype") == "grid") {
            ...
            if (!empty($record)) {
                $values = database::get_all("unilabeltype_grid_tile", $record->id, "gridid");
