...
/**
 * Class to manage a lesson plugin activity
 * 
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class lesson extends \local_ezxlate\entity {
    ...
    protected function define_fields() {
        ...
        $this->add_entities_from_table("pages",  [ "title", "contents"], "lesson_pages", "lessonid");
        $this->add_entities_from_table("answers",  [ "answer", "response"], "lesson_answers", "lessonid");
    }
}